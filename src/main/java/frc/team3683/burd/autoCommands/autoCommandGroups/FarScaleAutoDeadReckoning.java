...
public class FarScaleAutoDeadReckoning extends CommandGroup {

    public FarScaleAutoDeadReckoning(){
        ...
        addSequential(new DriveStraightAbsoluteDec(223, 1.0, 6.0, -90.0, 1.0, true, 0.5, 0.75));
