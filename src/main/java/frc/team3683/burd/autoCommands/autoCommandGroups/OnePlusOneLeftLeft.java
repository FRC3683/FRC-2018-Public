...
public class OnePlusOneLeftLeft extends CommandGroup {

    public OnePlusOneLeftLeft(){
        ...
        addSequential(new DriveStraightAbsoluteDec(103, 1.0, 2.0, -60, 2.0, true, 0.8, 0.9));
