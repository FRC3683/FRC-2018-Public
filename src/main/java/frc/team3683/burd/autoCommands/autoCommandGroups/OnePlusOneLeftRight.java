...
public class OnePlusOneLeftRight extends CommandGroup {

    public OnePlusOneLeftRight(){
        ...
        addParallel(new DriveStraight(6, 0.5, 0.5));
        addSequential(new IntakeCommand(0.3, 0.5));
        addSequential(new WaitCommand(0.1));
        addParallel(new DelayedElevatorCommand(Constants.INSTANCE.getBottom(), 0.5));
        addSequential(new DriveStraightAbsolute(-78, 1.0, 1.8, 0, 1.0, true, 12.0));
        addParallel(new WristCommand(Constants.INSTANCE.getPotDown() - 3));
        addSequential(new DriveAngleAbsolute(38, 0.6, 0.6));
        addParallel(new DriveStraightAbsolute(76, 0.8, 2.5, 38, 1.0, true, 36.0));
        addSequential(new CurrentIntakeCommand(0.8));
        addSequential(new WaitCommand(0.1));
        addParallel(new WristCommand(Constants.INSTANCE.getPotUp()));
        addSequential(new WaitCommand(0.1));
        addParallel(new IntakeCommand(-0.5, 2.5));
        addSequential(new DriveStraightAbsoluteDec(-20, 1.0, 1.0, 38, 2.0, true, 0.5, 0.8));
        addSequential(new DriveAngleAbsolute(75, 0.8, 0.75));
        addSequential(new DriveStraightAbsoluteDec(133, 1.0, 2.0, 75, 2.0, true, 0.8, 0.9));
        ...
        addSequential(new DriveStraightAbsoluteDec(165, 1.0, 6.0, 0.0, 8.0, true, 0.6, 0.8));
