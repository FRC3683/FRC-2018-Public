...
public class OnePlusOneRightLeft extends CommandGroup {

    public OnePlusOneRightLeft(){
        ...
        addSequential(new DriveStraightAbsoluteDec(149, 1.0, 2.0, -75, 2.0, true, 0.8, 0.9));
        ...
        addSequential(new DriveStraightAbsoluteDec(173, 1.0, 6.0, 0.0, 8.0, true, 0.6, 0.8));
