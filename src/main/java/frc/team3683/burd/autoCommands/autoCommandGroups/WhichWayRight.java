...
public class WhichWayRight extends CommandGroup {

    public WhichWayRight(){
        ...
        addParallel(new DriveStraightAbsolute(64, 0.8, 2.5, -40, 1.0, true, 24.0));
        addSequential(new CurrentIntakeCommand(0.8));
        addSequential(new WaitCommand(0.1));
        addParallel(new WristCommand(Constants.INSTANCE.getPotUp()));
        addSequential(new WaitCommand(0.1));
        addParallel(new IntakeCommand(-0.5, 2.5));
        addSequential(new DriveStraight(-58, 1.0, 1.25));
        ...
        addParallel(new WristCommand(Constants.INSTANCE.getPotUp()));
        addSequential(new WaitCommand(0.1));
        addSequential(new DriveStraight(-12, 1.0, 1.0));
