package frc.team3683.burd.utils;
 ...
 *   from your burd code to avoid blocking the main burd program execution.
 *
 *  Example:
 ...
 *
 */
public class BNO055 extends AdafruitI2C {
    //Tread variables
...
//    private static I2C imu;
    ...
    private BNO055(I2C.Port port, byte address) {
        super(port, address, Device.BNO055);
...
//					+ ", next: " + nextTime);
            ...
            switch(state) {
                ...
                case 1:
                    if(currentTime >= nextTime) {
                        //Switch to ca.team3683.config mode (just in case since this is the default)
                ...
                case 2:
                    // Reset
                    if(currentTime >= nextTime){
                        write8(reg_t.BNO055_SYS_TRIGGER_ADDR.getVal(), (byte) 0x20);
                        state++;
                    }
                    break;
                case 3:
                ...
                case 4:
                    ...
                    if(currentTime >= nextTime) {
                        ...
                        write8(reg_t.BNO055_PWR_MODE_ADDR.getVal(), (byte) powermode_t.POWER_MODE_NORMAL.getVal());
                        nextTime = Timer.getFPGATimestamp() + 0.050;
                        state++;
                    }
                    break;
                case 5:
                    ...
                    if(currentTime >= nextTime) {
                        write8(reg_t.BNO055_PAGE_ID_ADDR.getVal(), (byte) 0x00);
                        nextTime = Timer.getFPGATimestamp() + 0.050;
                        state++;
                    }
                    break;
                case 6:
                    if(currentTime >= nextTime) {
                        write8(reg_t.BNO055_SYS_TRIGGER_ADDR.getVal(), (byte) 0x80);
    ...
    private void setMode(int mode) {
        _mode = mode;
        write8(reg_t.BNO055_OPR_MODE_ADDR.getVal(), (byte) _mode);
    }
